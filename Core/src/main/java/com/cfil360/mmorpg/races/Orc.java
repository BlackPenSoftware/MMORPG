...
public class Orc implements Race{
    ...
    public Orc(String name, int strength, int endurance, int agility, int willpower, int wisdom, int intelligence, int accuracy, double speed, double sprint, double swim) {
        this.name = name;
