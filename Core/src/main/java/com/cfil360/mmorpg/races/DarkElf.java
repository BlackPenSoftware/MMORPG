...
public class DarkElf implements Race {
    ...
    //TODO: initialize all variables here rather than in a constructor
    ...
    public DarkElf(String name, int strength, int endurance, int agility, int willpower, int wisdom, int intelligence, int accuracy, double speed, double sprint, double swim) {
        this.name = name;
