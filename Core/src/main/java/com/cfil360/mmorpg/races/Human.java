...
public class Human implements Race{
    ...
    public Human(String name, int strength, int endurance, int agility, int willpower, int wisdom, int intelligence, int accuracy, double speed, double sprint, double swim) {
        this.name = name;
